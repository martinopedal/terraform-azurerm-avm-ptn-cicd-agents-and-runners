# Copilot Instructions: martinopedal/terraform-azurerm-avm-ptn-cicd-agents-and-runners

## Project Overview

AVM pattern module for Linux ACA GitHub Runners. Fork of Azure/terraform-azurerm-avm-ptn-cicd-agents-and-runners (v0.6.0-mp.2).

## Tech Stack

- **Language/Framework**: Terraform module, Azure Container Apps, AVM pattern, KEDA, AzAPI
...
v0.6.0-mp.2 mp-fork. Consumed by personal-runners-infra Linux ACA. KEDA at eventTriggerConfig.scale.rules[].
